...
const NavItem: React.FC<NavItemProps> = ({ icon, label, targetPage, currentPage, setPage, badgeCount = 0, onClick, onNavigate }) => {
...
const Sidebar: React.FC<SidebarProps> = ({ page, setPage, currentUser, notifications, onMarkNotificationsRead, isOpen, isDesktop, onClose }) => {
    ...
    return (
        <aside
            className={`
                w-64 bg-surface text-text-primary flex flex-col p-4 border-l border-gray-700
